...
function Header() {
  ...
  return (
    <div>
      <nav
        // style="transition: top 0.8s ease 0s; top: 0px;"
        id="main_navbar"
        class="sticky top-0 z-50 flex items-center justify-between gap-8 px-2 py-2 bg-gray-100 shadow  text-gray-800 border-b md:px-2"
      >
        ...
        <div class="flex items-center justify-center gap-x-4">
          <section className="text-gray-500 cursor-pointer text-lg hover:text-gray-900">
            Projects
          </section>
          <section className="text-gray-500 cursor-pointer text-lg hover:text-gray-900">
            Projects
        ...
        <div class="hidden lg:flex items-center gap-2 cursor-pointer relative group">
          <div className="absolute hidden   py-2.5  px-2.5 -left-10  bg-gray-100 border   border-gray-200 shadow top-14 cursor-auto group-hover:block">
            <div className="flex gap-x-6">
              ...
              <div className=" flex flex-col justify-center">
                ...
                <section className="text-base text-gray-600 font-medium">
