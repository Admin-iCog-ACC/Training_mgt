...
const SendingGeneratedLinkEmailTemplate = (trainer, link, giver) => {
  return `<!DOCTYPE html>
  <html lang="en">
    <head>
      <meta charset="UTF-8" />
    ...
    <body>
      ...
      >
        ...
        <div style="margin: 10px 0px; color: #222;">
          Below are your account profile:
  
          <section style="margin: 5px 20px">
            Full Name:
            <span style="font-weight: bold">${trainer.firstName} ${trainer.lastName}</span>
          </section>
          <section style="margin: 5px 20px">
            Email:
  ...
  <div 
  style="color: #222;">
  Please use ${link} to activate your account. For
  security purposes, you should be able to activate your account within 30 minutes.  
        If you have any questions or need further assistance,
        please don't hesitate to contact your account provider at
        <span style="font-weight: bold">${giver.email}</span>
        <div style="margin: 3px 0px;color: #222;">
